...
public class ResultSet implements java.sql.ResultSet {
    ...
    public String getString(int columnIndex) throws SQLException {
        return (String)rows.get(index.get())[columnIndex -1];
    }

    @Override
    public boolean getBoolean(int columnIndex) throws SQLException {
        return (boolean) rows.get(index.get())[columnIndex -1];
    }

    @Override
    public byte getByte(int columnIndex) throws SQLException {
        return (byte) rows.get(index.get())[columnIndex -1];
    }
    ...
    public int getInt(int columnIndex) throws SQLException {
        return (int)rows.get(index.get())[columnIndex - 1];
    }

    @Override
    public long getLong(int columnIndex) throws SQLException {
        return (long)rows.get(index.get())[columnIndex -1];
    }
